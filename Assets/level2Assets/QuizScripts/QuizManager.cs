...
public class QuizManager : MonoBehaviour {
    ...
    public void Accept()
    {
        ...
        var type 
            = (IsFinished) 
            ? UIManager.TransitionScreenType.Finish 
            : (isCorrect) ? UIManager.TransitionScreenType.Correct 
            : UIManager.TransitionScreenType.Incorrect;

        events.DisplayTransitionScreen?.Invoke(type, data.Questions[currentQuestion].AddScore);

       // AudioManager.Instance.PlaySound((isCorrect) ? "CorrectSFX" : "IncorrectSFX");

        if (type != UIManager.TransitionScreenType.Finish)
        {
